...
public class UpdateInternalAgent {
	...
	public void LoginToApp() throws InvalidFormatException, IOException, AWTException, InterruptedException, ClassNotFoundException, SQLException 
	{
	 ...
	 @Test
	public void verifyUpdatingInternalAgent() throws InvalidFormatException, IOException 
	{
		 try
		 {
			  String salesId = eLib.getExcelData("Sheet1", 1, 4);
			  double dealerCode = eLib.getExcelNumericData("Sheet1", 1, 5);
			 // System.out.println(dealerCode);
			  hmObj.navigateTo1082HierSearchPage();
			  hmObj.navigateToAgentInfoPage(salesId);
			  hmObj.updateInternalAgent((int)dealerCode);
			  System.out.println("Internal Agent Updated Successfully");
		 }
		 catch(Exception e)
		 {
			 System.out.println("Internal Agent Updation Failed");
		 }
