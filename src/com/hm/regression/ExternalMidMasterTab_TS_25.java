...
public class ExternalMidMasterTab_TS_25 extends TestConfigu {
	Logger logger = Logger.getLogger(" MidMasterReletionShip  Class");

	@Test
	public void veifyExtMidMasterTab_TC_31() throws FindFailed,
		...
		midMaster.deleteMidMasterRel();
		logger.info("click on delete check box");
		screen.wait(saveBtn, 30);
