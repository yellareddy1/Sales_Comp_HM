...
public class FirstLinkSelectedIssueScreen 
{
  ...
  @Test
  public void navigationToAllIssuePage()
	   {
		  try
		  {
			String expectedText = eLib.getExcelData("Sheet1", 1, 3);
			//System.out.println(expectedText);
			citsObj.selectedIssuesPageFirstLink(expectedText);
			System.out.println("Successfully navigated to Selected Issue Page");
				
		  }
		  catch(Exception e)
		  {
			  System.out.println("Navigation failed to Issue Preview Page"); 
		  }
	   }
