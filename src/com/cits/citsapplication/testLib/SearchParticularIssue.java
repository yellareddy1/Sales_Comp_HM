...
public class SearchParticularIssue 
{
  ...
  @Test
  public void searchIssue() throws InvalidFormatException, IOException, InterruptedException 
  {
	 try
	 {
		int issueNo = (int) (eLib.getExcelNumericData("Sheet1", 1, 8));
		//System.out.println(issueNo);
		searchPageObj.searchWithIssueNumber(issueNo);
		System.out.println("Successfully navigated to SearchPage");
	 }
