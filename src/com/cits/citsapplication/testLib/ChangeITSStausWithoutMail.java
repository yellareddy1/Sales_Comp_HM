...
public class ChangeITSStausWithoutMail 
{
  ...
  @Test
  public void changePreviewPageITSStatus()
  {
	 try
	  {
		 citsObj.selectedIssuePreviewPage();
		 citsObj.changeITSStatus();
		 System.out.println("Successfully changed the ITS Status");
		
	  }
	  catch(Exception e)
	  {
		  System.out.println("Failed to change the ITS status"); 
	  }
  }
