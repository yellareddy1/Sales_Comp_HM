...
public class PreviewPageITSSummaryLink 
{
  ...
  @Test
  public void navigationToPreviewPageITSSummaryLink()
  {
	 try
	  {
		 String expectedText = eLib.getExcelData("Sheet1", 1, 6);
		 //System.out.println(expectedText); 
		 citsObj.selectedIssuePreviewPage();
		 citsObj.previewPageITSSummaryLink(expectedText);
		 System.out.println("Successfully navigated to Preview Page ITS Summary Link");
		
	  }
	  catch(Exception e)
	  {
		  System.out.println("Navigation failed to Preview Page ITS Summary Link"); 
	  }
  }
