...
public class SearchByIssueType 
{
	...
	@Test
	public void searchIssueByType() throws InvalidFormatException, IOException, InterruptedException
	  {
		try
		{
			String expectedType = eLib.getExcelData("Sheet1", 1, 10);
			//System.out.println(expectedType);
			searchPageObj.searchWithIssueType(expectedType);
