...
public class SearchByIssueStatus {
	...
	@Test
	public void searchIssueByStatus() throws InvalidFormatException, IOException, InterruptedException
	  {
		  try
		  {
			String expectedStatus = eLib.getExcelData("Sheet1", 1, 9);
		//	System.out.println(expectedStatus);
			searchPageObj.searchWithIssueStatus(expectedStatus);
